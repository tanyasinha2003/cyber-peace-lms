...
import './ClassesandCalender.css'
import ImgAsset from '../public'
import {Link} from 'react-router-dom'
export default function ClassesandCalender () {
	return (
		<div className='ClassesandCalender_ClassesandCalender'>
			...
			<div className='gridiconsdropdown'>
				<img className='Vector' src = {ImgAsset.ClassesandCalender_Vector} />
			</div>
			...
			<span className='January2024'>January 2024</span>
			...
			<div className='Group21'>
				<span className='_400pm600pm'>4:00pm-6:00pm</span>
				<span className='JohnDoe'>John Doe</span>
				<span className='CyberSecurityAnalyst'>Cyber Security Analyst</span>
				<img className='Ellipse3' src = {ImgAsset.ClassesandCalender_Ellipse3} />
			</div>
			<div className='Group22'>
				<span className='_400pm600pm_1'>4:00pm-6:00pm</span>
				<span className='JohnDoe_1'>John Doe</span>
				<span className='EthicalHackingEssential'>Ethical Hacking Essential</span>
				<img className='Ellipse3_1' src = {ImgAsset.ClassesandCalender_Ellipse3_1} />
			</div>
			<div className='bitcoiniconscrossoutline'>
				<img className='Vector_1' src = {ImgAsset.ClassesandCalender_Vector_1} />
			</div>
		</div>
	)
}